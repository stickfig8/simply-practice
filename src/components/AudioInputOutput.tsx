...
export default function AudioInputOutput() {
    const {devices, inputId, channel, channelCount, volume,
        setInputId, setChannel, setVolume } = useAudioInputStore();
    ...
    return (
        <div className="p-4 space-y-4">
            ...
            <div>
                <label>input : </label>
                <select value={inputId ?? ""} onChange={(e) => setInputId(e.target.value === "" ? null : e.target.value)} className="ml-2">
